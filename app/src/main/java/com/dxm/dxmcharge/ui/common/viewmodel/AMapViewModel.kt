package com.dxm.dxmcharge.ui.common.viewmodel
...
import com.charge.lib.storage.service.location.LocationInfo
...
class AMapViewModel : BaseViewModel(), GeocodeSearch.OnGeocodeSearchListener {
    private val geocodeSearch = GeocodeSearch(App.instance())
